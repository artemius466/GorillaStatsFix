...
#equires -Modules @{ ModuleName="Microsoft.PowerShell.Archive"; ModuleVersion="1.2.3" }
...
cp bin\Release\netstandard2.1\$Name.dll "E:\SteamLibrary\steamapps\common\Gorilla Tag\BepInEx\plugins\$Name\"
